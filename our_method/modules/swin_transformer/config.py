...
#-----------------------------------------------------------------------------
# Environment setting
# mtsecutrity _mainは29500, ablationは295001
#-----------------------------------------------------------------------------
_C.DISTRIBUTED = CN()
_C.DISTRIBUTED.ENABLE = True
_C.DISTRIBUTED.BACKEND = "nccl"
_C.DISTRIBUTED.INIT_METHOD="tcp://localhost:29500"
_C.DISTRIBUTED.PORT=29500
...
_C.MODEL.NUM_CLASSES = 11
# Dropout rate
_C.MODEL.DROP_RATE = 0.3
# Drop path rate
_C.MODEL.DROP_PATH_RATE = 0.1

# BarlowTwins Loss adjustment parameter
_C.MODEL.LAMBDA1 = 1e-3
_C.MODEL.LAMBDA2 = 1e-3
_C.MODEL.LAMBDA3 = 1e-3
...
# GNN prameters
_C.MODEL.GNN = CN()
_C.MODEL.GNN.SAMPLE_MODEL = 'sage'
_C.MODEL.GNN.EMBED_DIM = 64
_C.MODEL.GNN.FAST_EMBED_DIM = None
_C.MODEL.GNN.NODE_SAMPLE_NUM = [480, 480 ,480]
_C.MODEL.GNN.NUM_BLOCK = 2
_C.MODEL.GNN.FAST_NUM_BLOCK = 1
_C.MODEL.GNN.DROP_RATE = 0.3
_C.MODEL.GNN.ACTIVE = 'leaky'
_C.MODEL.GNN.NEGATIVE_SLOPE = 0.01
_C.MODEL.GNN.ALPHA = 0.2
_C.MODEL.GNN.HEAD_NUM = 6
_C.MODEL.GNN.ALLOW_ZERO = True
_C.MODEL.GNN.DEPTHS = [3,3,3,3,3,3]
...
_C.MODEL.SWIN_MOE.EMBED_DIM = 64
...
_C.MODEL.SWIN_MLP.EMBED_DIM = 64
