...
try:
    ...
    from modules.swin_transformer.kernels.window_process.window_process import WindowProcess, WindowProcessReverse
...
class Mlp(nn.Module):
    ...
    def forward(self, x):
        ...
        # debug用
        #debug_check(x, "x (input to block)")
...
class SwinTransformer(nn.Module):
    ...
    Args:
        ...
        in_chans (int): Number of input image channels. Default: 3
        num_classes (int): Number of classes for classification head. Default: 11
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=11,
        ...
        # 最終出力層
        self.head = nn.Linear(self.num_features, self.embed_dim) if num_classes > 0 else nn.Identity()
